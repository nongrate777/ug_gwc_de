	...
	<div class="wpcdt-sf-wrap">
		<div class="wpcdt-sf-inr">
			<div class="wpcdt-sf-features-section wpcdt-sf-team wpcdt-sf-center">
				<h1 class="wpcdt-sf-heading">Now get best value from <span class="wpcdt-sf-blue">Annual</span> and <span class="wpcdt-sf-blue">Lifetime</span> deal</h1>
			...
			<div class="wpcdt-sf-features-section wpcdt-sf-team wpcdt-sf-center">
				<h1 class="wpcdt-sf-heading">Powerful Team Behind <span class="wpcdt-sf-blue">Countdown Timer</span></h1>
					...
					<p></p>
					<div class="wpcdt-sf-cont">This is why I wanted to introduce you to <span class="wpcdt-sf-blue">Anoop Ranawat & Team</span> at EssentialPlugin.com</div>
			...
			<div class="wpcdt-sf-welcome-wrap">
				<div class="wpcdt-sf-welcome-inr wpcdt-sf-center">						
						...
						<a href="<?php echo esc_url( $wpcdt_add_link ); ?>" class="wpcdt-sf-btn">Launch Countdown Timer With Free Features</a> <br /><b>OR</b> <br /><a href="<?php echo WPCDT_PLUGIN_BUNDLE_LINK; ?>"  target="_blank" class="wpcdt-sf-btn wpcdt-sf-btn-orange"><span class="dashicons dashicons-cart"></span> Grab Now With Essential Bundle</a>
			...
			<div class="wpcdt-sf-features-section">
				...
				<div class="wpcdt-sf-welcome-wrap wpcdt-sf-center">
					...
					<a href="<?php echo WPCDT_PLUGIN_BUNDLE_LINK; ?>" target="_blank" class="wpcdt-sf-btn wpcdt-sf-btn-orange"><span class="dashicons dashicons-cart"></span> Grab Now Pro Features</a>
					<div class="wpcdt-sf-rc-wrap">
						<div class="wpcdt-sf-rc-inr wpcdt-sf-rc-bg-box">
							<div class="wpcdt-sf-rc-icon">
								<img src="<?php echo esc_url( WPCDT_URL ); ?>assets/images/popup-icon/14-days-money-back-guarantee.png" alt="14-days-money-back-guarantee" title="14-days-money-back-guarantee" />
			...
			<div class="wpcdt-sf-testimonial-wrap">
				<div class="wpcdt-sf-center wpcdt-features-ttl">
					<h1 class="wpcdt-sf-heading">Looking for a Reason to Use <span class="wpls-sf-blue">Countdown Timer? </span></h1>
				...
				<div class="wpcdt-sf-testimonial-section-inr">
					...
					<a href="https://wordpress.org/support/plugin/countdown-timer-ultimate/reviews/?filter=5" target="_blank" class="wpcdt-sf-btn"><span class="dashicons dashicons-star-filled"></span> View All Reviews</a> OR <a href="<?php echo WPCDT_PLUGIN_BUNDLE_LINK; ?>"  target="_blank" class="wpcdt-sf-btn wpcdt-sf-btn-orange"> <span class="dashicons dashicons-cart"></span> Grab Now Pro Features</a>
					<div class="wpcdt-sf-rc-wrap">
						<div class="wpcdt-sf-rc-inr wpcdt-sf-rc-bg-box">
							<div class="wpcdt-sf-rc-icon">
								<img src="<?php echo esc_url( WPCDT_URL ); ?>assets/images/popup-icon/14-days-money-back-guarantee.png" alt="14-days-money-back-guarantee" title="14-days-money-back-guarantee" />
