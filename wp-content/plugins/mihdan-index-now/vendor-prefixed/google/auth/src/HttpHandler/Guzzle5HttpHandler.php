...
use Mihdan\IndexNow\Dependencies\GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
...
class Guzzle5HttpHandler
{
    ...
    {
        if (!\class_exists('Mihdan\\IndexNow\\Dependencies\\GuzzleHttp\\Promise\\Promise')) {
