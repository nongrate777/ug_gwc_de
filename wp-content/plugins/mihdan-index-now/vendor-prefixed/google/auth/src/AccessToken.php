...
use Mihdan\IndexNow\Dependencies\phpseclib\Math\BigInteger;
...
class AccessToken
{
    ...
    public function verify($token, array $options = [])
    {
        ...
        try {
            ...
            // firebase/php-jwt 3+
        } catch (\Mihdan\IndexNow\Dependencies\ExpiredException $e) {
            // firebase/php-jwt 2
        } catch (SignatureInvalidException $e) {
            // firebase/php-jwt 3+
        } catch (\Mihdan\IndexNow\Dependencies\SignatureInvalidException $e) {
            // firebase/php-jwt 2
    ...
    {
        // @codeCoverageIgnoreStart
        if (!\class_exists('Mihdan\\IndexNow\\Dependencies\\SimpleJWT\\JWT')) {
    ...
    private function setPhpsecConstants()
    {
        if (\filter_var(\getenv('GAE_VM'), \FILTER_VALIDATE_BOOLEAN)) {
            ...
            if (!\defined('Mihdan\\IndexNow\\Dependencies\\CRYPT_RSA_MODE')) {
                \define('Mihdan\\IndexNow\\Dependencies\\CRYPT_RSA_MODE', RSA::MODE_OPENSSL);
            }
        }
    }
    /**
    ...
    {
        $class = \class_exists('Mihdan\\IndexNow\\Dependencies\\Firebase\\JWT\\JWT') ? 'Firebase\\JWT\\JWT' : 'JWT';
