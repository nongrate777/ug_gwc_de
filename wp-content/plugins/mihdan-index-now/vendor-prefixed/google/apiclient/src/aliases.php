...
if (\false) {
    ...
    class Google_AuthHandler_Guzzle5AuthHandler extends \Mihdan\IndexNow\Dependencies\Google\AuthHandler\Guzzle5AuthHandler
    {
    }
