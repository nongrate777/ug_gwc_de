...
class MongoDBHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!($mongo instanceof \MongoClient || $mongo instanceof \Mongo || $mongo instanceof \Mihdan\IndexNow\Dependencies\MongoDB\Client)) {
    ...
    {
        if ($this->mongoCollection instanceof \Mihdan\IndexNow\Dependencies\MongoDB\Collection) {
